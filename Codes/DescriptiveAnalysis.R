#DELAY GRAPHS
#Descriptive analysis by siddharth singh

library(tidyr)
library(dplyr )
library(ggplot2) # flight visualization
library(readr) # CSV file I/O, e.g. the read_csv function
flight<-read_csv('C:/Users/siddharth/Desktop/FlightData_Linear_Hypothesis.csv')
summary(flight)
...
#Based on above plot, least amount of delay's happen on Tuesday's, Wednesday's, thursday's and #Saturday's while there is a changes flight being delayed on Monday's, Friday's and Sunday's #if you fly from DCA to JFK based on 2015 Flights flight.
